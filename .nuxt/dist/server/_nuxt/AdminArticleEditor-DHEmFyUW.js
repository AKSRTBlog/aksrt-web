...
import { _ as _sfc_main$3 } from "./MediaPickerDialog-CKbzUmQT.js";
import { t as renderMarkdown } from "./api-9xEAR-2s.js";
import { u as useAdminSession } from "./useAdminSession-fnHBOwsd.js";
import { c as createEmptyArticleForm, a as countWords, e as estimateReadingTime, d as slugifyArticleTitle, f as buildArticlePayload, g as clearDraftSnapshot, m as mapArticleToEditorForm, h as saveDraftSnapshot, i as insertTextAtSelection } from "./admin-editor-CUf6Pf5Q.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        if (unref(viewMode) !== "edit") {
          _push(`<div class="${ssrRenderClass([unref(viewMode) === "preview" ? "" : "bg-white", "h-[720px] overflow-y-auto"])}"><article class="article-content admin-markdown-preview mx-auto max-w-none px-6 py-6">${unref(previewHtml) ?? ""}</article></div>`);
        } else {
          _push(`<!---->`);
        }
...
//# sourceMappingURL=AdminArticleEditor-DHEmFyUW.js.map
