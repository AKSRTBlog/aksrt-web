...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.B_wqI9yl.mjs').then(interopDefault),
  ...
  "layouts/admin.vue": () => import('./_nuxt/admin-styles.lt8ivzME.mjs').then(interopDefault),
  "layouts/admin.vue?vue&type=style&index=0&lang.css": () => import('./_nuxt/admin-styles.lt8ivzME.mjs').then(interopDefault)
}