...
import { _ as _sfc_main$3 } from './MarkdownContent-BbiPhAn4.mjs';
import { defineComponent, computed, withAsyncContext, unref, mergeProps, withCtx, createTextVNode, toDisplayString, ref, useSSRContext } from 'vue';
...
import { _ as _sfc_main$6 } from './AppImage-CpDcJIeD.mjs';
import { f as fetchPublicSiteSettings, q as fetchPublicArticleDetail, i as fetchAllPublicArticles, s as sortArticles, c as blogAuthor, g as formatDate, r as fetchPublicComments } from './api-9xEAR-2s.mjs';
import { u as useGeeTestCaptcha } from './useGeeTestCaptcha-DFKF46Gm.mjs';
import { u as useAsyncData } from './asyncData-BA1__WkK.mjs';
import { _ as _sfc_main$4 } from './ArticleCard-BxTDfe5W.mjs';
import { _ as _sfc_main$5 } from './EmptyState-6npZcwUe.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      const _component_CommentThread = _sfc_main$2;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "mt-16" }, _attrs))}><div class="flex items-center gap-3"><h2 class="text-2xl font-semibold text-[var(--blog-ink)]">Comments</h2><span class="rounded-full bg-[var(--blog-soft)] px-3 py-1 text-xs text-[var(--blog-subtle)]">${ssrInterpolate(((_a = unref(comments)) == null ? void 0 : _a.length) || 0)}</span></div>`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const articleIndex = computed(() => orderedArticles.value.findIndex((item) => {
      var _a;
      return item.slug === ((_a = article.value) == null ? void 0 : _a.slug);
    }));
    ...
    const primaryCategory = computed(() => {
      var _a, _b;
      return ((_b = (_a = article.value) == null ? void 0 : _a.categories) == null ? void 0 : _b[0]) || null;
    });
    ...
    const relatedArticles = computed(() => {
      ...
      return orderedArticles.value.filter((item) => {
        var _a;
        return item.id !== ((_a = article.value) == null ? void 0 : _a.id) && item.categories.some((cat) => categorySlugs.has(cat.slug));
      }).slice(0, 3);
    });
    useSeoMeta({
      title: () => {
        var _a;
        return ((_a = article.value) == null ? void 0 : _a.title) || "Article";
      },
      description: () => {
        var _a, _b;
        return ((_a = article.value) == null ? void 0 : _a.excerpt) || ((_b = siteSettings.value) == null ? void 0 : _b.siteDescription) || "";
      }
    });
    useHead(() => ({
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_MarkdownContent = _sfc_main$3;
      const _component_CommentSection = _sfc_main$1;
      const _component_ArticleCard = _sfc_main$4;
      ...
      if (unref(article)) {
        ...
        _push(`<span>/</span><span>${ssrInterpolate(((_a = unref(primaryCategory)) == null ? void 0 : _a.name) || "Uncategorized")}</span></div><div class="mt-6 flex flex-wrap gap-2"><!--[-->`);
...
//# sourceMappingURL=_slug_-m_0HVPn9.mjs.map
