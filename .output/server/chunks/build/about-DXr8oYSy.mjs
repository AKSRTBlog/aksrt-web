import { _ as _sfc_main$3 } from './PageHero-mei_8pXg.mjs';
...
import { f as fetchPublicSiteSettings, a as fetchActivityStats, b as fetchPublicProjects, c as blogAuthor } from './api-9xEAR-2s.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const contactLinks = computed(() => {
      var _a;
      const githubUsername = (_a = siteSettings.value) == null ? void 0 : _a.githubUsername;
      return [
    ...
    useSeoMeta({
      ...
      description: () => {
        var _a;
        return ((_a = siteSettings.value) == null ? void 0 : _a.siteDescription) || blogAuthor.bio;
      }
    });
    return (_ctx, _push, _parent, _attrs) => {
...
//# sourceMappingURL=about-DXr8oYSy.mjs.map
