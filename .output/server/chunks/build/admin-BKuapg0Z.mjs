...
import { g as getAdminRouteTitle, c as buildAdminCravatarUrl, d as fallbackAdminAvatar, e as adminNavSections, i as isAdminNavItemActive } from './admin-BhXx1q9A.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const profileName = computed(() => {
      var _a, _b;
      return ((_a = profile.value) == null ? void 0 : _a.displayName) || ((_b = profile.value) == null ? void 0 : _b.username) || "Admin";
    });
    const profileEmail = computed(() => {
      var _a, _b;
      return ((_b = (_a = profile.value) == null ? void 0 : _a.email) == null ? void 0 : _b.trim()) || "";
    });
    const profileAvatar = computed(() => {
      ...
      return ((_a = profile.value) == null ? void 0 : _a.avatarUrl) || fallbackAdminAvatar;
    });
...
//# sourceMappingURL=admin-BKuapg0Z.mjs.map
