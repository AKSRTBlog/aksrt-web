        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if ((_a = __props.siteSettings) == null ? void 0 : _a.logoUrl) {
              ...
              _push2(`<div class="flex h-12 w-12 items-center justify-center rounded-[1.25rem] bg-[var(--blog-ink)] text-sm font-semibold text-white"${_scopeId}>${ssrInterpolate((((_b = __props.siteSettings) == null ? void 0 : _b.siteTitle) || "Blog").slice(0, 2).toUpperCase())}</div>`);
            }
            _push2(`<div class="min-w-0"${_scopeId}><p class="truncate text-sm font-semibold tracking-[0.18em] text-[var(--blog-ink)]"${_scopeId}>${ssrInterpolate(((_c = __props.siteSettings) == null ? void 0 : _c.siteTitle) || "Blog")}</p><p class="mt-1 text-xs text-[var(--blog-subtle)]"${_scopeId}>${ssrInterpolate((((_d = __props.siteSettings) == null ? void 0 : _d.siteDescription) || "").slice(0, 30))}${ssrInterpolate((((_e = __props.siteSettings) == null ? void 0 : _e.siteDescription) || "").length > 30 ? "..." : "")}</p></div>`);
          } else {
            return [
              ((_f = __props.siteSettings) == null ? void 0 : _f.logoUrl) ? (openBlock(), createBlock(_sfc_main$1, {
                key: 0,
                src: __props.siteSettings.logoUrl,
                alt: __props.siteSettings.siteTitle,
                class: "h-12 w-12 rounded-[1.25rem] object-cover",
              ...
              createVNode("div", { class: "min-w-0" }, [
                createVNode("p", { class: "truncate text-sm font-semibold tracking-[0.18em] text-[var(--blog-ink)]" }, toDisplayString(((_h = __props.siteSettings) == null ? void 0 : _h.siteTitle) || "Blog"), 1),
                createVNode("p", { class: "mt-1 text-xs text-[var(--blog-subtle)]" }, toDisplayString((((_i = __props.siteSettings) == null ? void 0 : _i.siteDescription) || "").slice(0, 30)) + toDisplayString((((_j = __props.siteSettings) == null ? void 0 : _j.siteDescription) || "").length > 30 ? "..." : ""), 1)
              ])
            ];
          }
        }),
...
//# sourceMappingURL=SiteSidebar-DbsjUJRM.mjs.map
