...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.B_wqI9yl.mjs').then(interopDefault),
  ...
  "layouts/admin.vue": () => import('./admin-styles.lt8ivzME.mjs').then(interopDefault),
  "layouts/admin.vue?vue&type=style&index=0&lang.css": () => import('./admin-styles.lt8ivzME.mjs').then(interopDefault)
};
