...
export const fallbackAdminAvatar =
  'data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%2280%22 height=%2280%22 viewBox=%220 0 80 80%22%3E%3Crect width=%2280%22 height=%2280%22 rx=%2240%22 fill=%22%231e293b%22/%3E%3Ctext x=%2250%25%22 y=%2252%25%22 dominant-baseline=%22middle%22 text-anchor=%22middle%22 fill=%22%23ffffff%22 font-family=%22sans-serif%22 font-size=%2230%22%3EAK%3C/text%3E%3C/svg%3E'
...
function rhex(value: number) {
  ...
  for (let index = 0; index < 4; index += 1) {
    output += hex[(value >> (index * 8 + 4)) & 0x0f] + hex[(value >> (index * 8)) & 0x0f]
  }
